...
function LoggedOutNav() {
    ...
    const pages = [<Link className="navLink" to="/about">About LYSTR</Link>, <Link className="listTheme">List Your Stuff</Link>, <Link to="/login" className="navLink">Sign in</Link>];
